...
if ($bash_isProductionEnvironment=="true") {
    $filename_path = $properties["environment_production"]["pro.file.folder.alertofdown"];
} else {
    $filename_path = $properties["environment_develop"]["dev.file.folder.alertofdown"];
}
$filename =  $properties["generals"]["general.file.alertofdown"];
